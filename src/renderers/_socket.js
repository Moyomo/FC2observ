	...
	connect: () =>  {
		...
		if (navigator.userAgent.toLowerCase().indexOf(" electron/") > -1) {
			...
			.then(data => {
				...
				console.info(`%cFC2observ %cv${data.version}%c, at your service ❤ `, "font-weight: bold", "font-weight: bold; color:red", "font-weight: bold", "https://github.com/Moyomo/FC2observ/")
			})
			.catch((err) => {
				console.error(err)
